...
txtDisplay = Entry(calc, font=('Roboto', 20, 'bold'),
                   bg='white', fg='black',
...
Button(calc, text=chr(177), width=6,
       height=2, bg='thistle', font=('Roboto', 20, 'bold'),
...
Button(calc, text="tanh", width=6,
       height=2, bg='white', fg='black',
       font=('Roboto', 20, 'bold'),
       bd=4, command=added_value.tanh
       ).grid(row=2, column=6, pady=1)

Button(calc, text="sinh", width=6,
       height=2, bg='white', fg='black',
       font=('Roboto', 20, 'bold'),
...
Button(calc, text="expm1", width=6,
       height=2, bg='white', fg='black',
       font=('Roboto', 20, 'bold'),
       bd=4, command=added_value.expm1
       ).grid(row=4, column=6, pady=1)

Button(calc, text="gamma", width=6,
       height=2, bg='white', fg='black',
       font=('Roboto', 20, 'bold'),
       bd=4, command=added_value.lgamma
       ).grid(row=4, column=7, pady=1)
Button(calc, text="log2", width=6,
       height=2, bg='white', fg='black',
       font=('Roboto', 20, 'bold'),
